...
class _CompanyPageState extends State<CompanyPage>
    ...
    return OrientationBuilder(builder: (context, orientation) {
      return BlocProvider<CompanyBloc>(
        create: (BuildContext ctx) {
          ...
          cmpBloc.add(CompanyBlocEvents.LOAD_COMPANY);
          return cmpBloc;
        },
                  ...
                  : widget.isTop20 == null
                      ? Scaffold(
                          appBar: orientation == Orientation.landscape
                              ? null
                              : buildAppBar(context, state.favData, false),
                          body: orientation == Orientation.landscape
                              ? LandscapeMode(
                                  cmpData, subscribedUser, CHART_TERM_MEDIUM)
                              : PortraitMode(
                                  cmpData, subscribedUser, state.favData),
                        )
                      : DefaultTabController(
                          ...
                          child: Scaffold(
                            appBar: orientation == Orientation.landscape
                                ? null
                                : buildAppBar(context, state.favData, true),
  ...
  Widget PortraitMode(cmpData, subscribedUser, favData) {
      ...
      InkWell(
        onTap: () async {
          if (widget.isFavourite && widget.hasNote) {
                      ...
                      SizedBox(
                        ...
                        child: TextButton(
                          ...
                          onPressed: () async {
                            ...
                            context
                                .read<CompanyBloc>()
                                .add(CompanyBlocEvents.FAVOURITE_LOADED);
            ...
            context.read<CompanyBloc>().add(CompanyBlocEvents.FAVOURITE_LOADED);
            eventBus.fire(ReloadEvent());
